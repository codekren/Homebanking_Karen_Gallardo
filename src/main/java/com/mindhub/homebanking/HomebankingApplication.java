...
public class HomebankingApplication {
	...
	public CommandLineRunner initData(ClientRepository clientRepository, AccountRepository accountRepository,
		...
		/*	Client client1 = new Client("Melba","Morel", "melba@mindhub.com",
			...
			Account account4 = new Account("VIN005", 10000, LocalDate.now());
			Account account5 = new Account("VIN006", 8000, LocalDate.now().plusDays(2));
			Account account6 = new Account("VIN007", 9000, LocalDate.now().plusDays(1));
			Account account7 = new Account("VIN008", 11000, LocalDate.now().plusDays(2));
			...
			Transaction transaction4 = new Transaction(2500, "buy pizza", LocalDateTime.now(), TransactionType.CREDIT);
			Transaction transaction5 = new Transaction(2500, "buy pizza", LocalDateTime.now(), TransactionType.CREDIT);
			Transaction transaction6 = new Transaction(2500, "buy pizza", LocalDateTime.now(), TransactionType.CREDIT);
