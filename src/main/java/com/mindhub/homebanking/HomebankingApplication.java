...
public class HomebankingApplication {
	...
	public CommandLineRunner initData(ClientRepository clientRepository, AccountRepository accountRepository,
		...
		return args -> {
			...
			Account account = new Account("VIN001", 5000, LocalDate.now(),0,true,AccountType.SAVINGS);
			Account account1 = new Account("VIN002", 7500, LocalDate.now().plusDays(1),1,true,AccountType.SAVINGS);
			Account account2 = new Account("BIN003", 8000, LocalDate.now(),0,true,AccountType.CHECKING);
			Account account3 = new Account("BIN004", 4000, LocalDate.now().plusDays(2),0,true,AccountType.CHECKING);
			Account account4 = new Account("VIN005", 10000, LocalDate.now(),0,true,AccountType.CHECKING);
			Account account5 = new Account("VIN006", 8000, LocalDate.now().plusDays(2),0,true,AccountType.SAVINGS);
			Account account6 = new Account("VIN007", 9000, LocalDate.now().plusDays(1),0,true,AccountType.CHECKING);
			Account account7 = new Account("VIN008", 11000, LocalDate.now().plusDays(2),0,true,AccountType.SAVINGS);
		...
		Loan loan1=new Loan("Mortgage",500000,0.1, List.of(12,24,36,48,60));
		Loan loan2=new Loan("Personal",100000,0.2,List.of(6,12,24));
		Loan loan3=new Loan("Automotive",300000,0.15, List.of(6,12,24,36));
		...
		loanRepository.save(loan3);
			...
			ClientLoan clientLoan1 = new ClientLoan(400000, 60,0.1,1,7333,true, client1, loan1);
			ClientLoan clientLoan2 = new ClientLoan(50000, 12,0.2,1,5555,true, client1, loan2);
			ClientLoan clientLoan3 = new ClientLoan(50000, 12,0.2,1,5888,true, client2, loan2);
			ClientLoan clientLoan4 = new ClientLoan(10000, 24,0.1,1,220,true, client3, loan1);
			ClientLoan clientLoan5 = new ClientLoan(25000, 6,0.2,1,4111,true, client5, loan2);
			ClientLoan clientLoan6 = new ClientLoan(55000, 6,0.2,1,11111,true, client6, loan2);
			ClientLoan clientLoan7 = new ClientLoan(60000, 24,0.1,1,5666,true, client6, loan1);
